...
//                    System.out.println(id));
    ...
    List<ProjectOverviewResponse> reslist=new ArrayList();

    for (int id:projectForId.keySet()) {
      ProjectOverviewResponse res=new ProjectOverviewResponse();
      if (  numExperimentsForProjId.get(id)!=null &&  numExperimentRunsForProjId.get(id)!=null  ){
        System.out.println(id);
        res=  new ProjectOverviewResponse(
                projectForId.get(id),
