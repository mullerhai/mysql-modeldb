...
public class Annotationfragment extends TableImpl<AnnotationfragmentRecord> {
    ...
    private static final long serialVersionUID = 1135968083;
     ...
     */
    public final TableField<AnnotationfragmentRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.ANNOTATIONFRAGMENT_ANNOTATION, Indexes.ANNOTATIONFRAGMENT_DATAFRAME, Indexes.ANNOTATIONFRAGMENT_EXPERIMENTRUN, Indexes.ANNOTATIONFRAGMENT_PRIMARY, Indexes.ANNOTATIONFRAGMENT_SPEC, Indexes.ANNOTATIONFRAGMENT_TRANSFORMER);
    }
    ...
    public Annotation annotation() {
        return new Annotation(this, Keys.ANNOTATIONFRAGMENT_IBFK_1);
    }

    public Transformer transformer() {
        return new Transformer(this, Keys.ANNOTATIONFRAGMENT_IBFK_2);
    }

    public Dataframe dataframe() {
        return new Dataframe(this, Keys.ANNOTATIONFRAGMENT_IBFK_3);
    }

    public Transformerspec transformerspec() {
        return new Transformerspec(this, Keys.ANNOTATIONFRAGMENT_IBFK_4);
    }

    public Experimentrun experimentrun() {
        return new Experimentrun(this, Keys.ANNOTATIONFRAGMENT_IBFK_5);
    }
