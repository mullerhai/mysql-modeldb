...
public class AnnotationfragmentDao extends DAOImpl<AnnotationfragmentRecord, jooq.mysql.gen.tables.pojos.Annotationfragment, Integer> {

    /**
     * Create a new AnnotationfragmentDao without any configuration
     */
    public AnnotationfragmentDao() {
        super(Annotationfragment.ANNOTATIONFRAGMENT, jooq.mysql.gen.tables.pojos.Annotationfragment.class);
    }
    ...
    public AnnotationfragmentDao(Configuration configuration) {
        super(Annotationfragment.ANNOTATIONFRAGMENT, jooq.mysql.gen.tables.pojos.Annotationfragment.class, configuration);
    }
     ...
     */
    @Override
    protected Integer getId(jooq.mysql.gen.tables.pojos.Annotationfragment object) {
        return object.getId();
    }
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Annotationfragment> fetchById(Integer... values) {
     ...
     */
    public jooq.mysql.gen.tables.pojos.Annotationfragment fetchOneById(Integer value) {
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Annotationfragment> fetchByAnnotation(Integer... values) {
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Annotationfragment> fetchByFragmentindex(Integer... values) {
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Annotationfragment> fetchByType(String... values) {
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Annotationfragment> fetchByTransformer(Integer... values) {
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Annotationfragment> fetchByDataframe(Integer... values) {
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Annotationfragment> fetchBySpec(Integer... values) {
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Annotationfragment> fetchByMessage(String... values) {
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Annotationfragment> fetchByExperimentrun(Integer... values) {
