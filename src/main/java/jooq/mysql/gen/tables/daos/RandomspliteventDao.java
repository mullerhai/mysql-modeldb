...
public class RandomspliteventDao extends DAOImpl<RandomspliteventRecord, jooq.mysql.gen.tables.pojos.Randomsplitevent, Integer> {

    /**
     * Create a new RandomspliteventDao without any configuration
     */
    public RandomspliteventDao() {
        super(Randomsplitevent.RANDOMSPLITEVENT, jooq.mysql.gen.tables.pojos.Randomsplitevent.class);
    }
    ...
    public RandomspliteventDao(Configuration configuration) {
        super(Randomsplitevent.RANDOMSPLITEVENT, jooq.mysql.gen.tables.pojos.Randomsplitevent.class, configuration);
    }
     ...
     */
    @Override
    protected Integer getId(jooq.mysql.gen.tables.pojos.Randomsplitevent object) {
        return object.getId();
    }
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Randomsplitevent> fetchById(Integer... values) {
     ...
     */
    public jooq.mysql.gen.tables.pojos.Randomsplitevent fetchOneById(Integer value) {
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Randomsplitevent> fetchByInputdataframeid(Integer... values) {
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Randomsplitevent> fetchByRandomseed(Long... values) {
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Randomsplitevent> fetchByExperimentrun(Integer... values) {
