...
public class PipelinestageDao extends DAOImpl<PipelinestageRecord, jooq.mysql.gen.tables.pojos.Pipelinestage, Integer> {

    /**
     * Create a new PipelinestageDao without any configuration
     */
    public PipelinestageDao() {
        super(Pipelinestage.PIPELINESTAGE, jooq.mysql.gen.tables.pojos.Pipelinestage.class);
    }
    ...
    public PipelinestageDao(Configuration configuration) {
        super(Pipelinestage.PIPELINESTAGE, jooq.mysql.gen.tables.pojos.Pipelinestage.class, configuration);
    }
     ...
     */
    @Override
    protected Integer getId(jooq.mysql.gen.tables.pojos.Pipelinestage object) {
        return object.getId();
    }
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Pipelinestage> fetchById(Integer... values) {
     ...
     */
    public jooq.mysql.gen.tables.pojos.Pipelinestage fetchOneById(Integer value) {
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Pipelinestage> fetchByPipelinefitevent(Integer... values) {
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Pipelinestage> fetchByTransformorfitevent(Integer... values) {
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Pipelinestage> fetchByIsfit(Integer... values) {
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Pipelinestage> fetchByStagenumber(Integer... values) {
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Pipelinestage> fetchByExperimentrun(Integer... values) {
