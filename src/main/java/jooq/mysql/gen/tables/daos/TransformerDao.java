...
public class TransformerDao extends DAOImpl<TransformerRecord, jooq.mysql.gen.tables.pojos.Transformer, Integer> {

    /**
     * Create a new TransformerDao without any configuration
     */
    public TransformerDao() {
        super(Transformer.TRANSFORMER, jooq.mysql.gen.tables.pojos.Transformer.class);
    }
    ...
    public TransformerDao(Configuration configuration) {
        super(Transformer.TRANSFORMER, jooq.mysql.gen.tables.pojos.Transformer.class, configuration);
    }
     ...
     */
    @Override
    protected Integer getId(jooq.mysql.gen.tables.pojos.Transformer object) {
        return object.getId();
    }
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Transformer> fetchById(Integer... values) {
     ...
     */
    public jooq.mysql.gen.tables.pojos.Transformer fetchOneById(Integer value) {
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Transformer> fetchByTransformertype(String... values) {
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Transformer> fetchByTag(String... values) {
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Transformer> fetchByExperimentrun(Integer... values) {
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Transformer> fetchByFilepath(String... values) {
