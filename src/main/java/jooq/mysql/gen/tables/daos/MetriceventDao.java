...
public class MetriceventDao extends DAOImpl<MetriceventRecord, jooq.mysql.gen.tables.pojos.Metricevent, Integer> {

    /**
     * Create a new MetriceventDao without any configuration
     */
    public MetriceventDao() {
        super(Metricevent.METRICEVENT, jooq.mysql.gen.tables.pojos.Metricevent.class);
    }
    ...
    public MetriceventDao(Configuration configuration) {
        super(Metricevent.METRICEVENT, jooq.mysql.gen.tables.pojos.Metricevent.class, configuration);
    }
     ...
     */
    @Override
    protected Integer getId(jooq.mysql.gen.tables.pojos.Metricevent object) {
        return object.getId();
    }
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Metricevent> fetchById(Integer... values) {
     ...
     */
    public jooq.mysql.gen.tables.pojos.Metricevent fetchOneById(Integer value) {
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Metricevent> fetchByTransformer(Integer... values) {
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Metricevent> fetchByDf(Integer... values) {
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Metricevent> fetchByMetrictype(String... values) {
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Metricevent> fetchByMetricvalue(Double... values) {
     ...
     */
    public List<jooq.mysql.gen.tables.pojos.Metricevent> fetchByExperimentrun(Integer... values) {
