...
public class Event extends TableImpl<EventRecord> {
    ...
    private static final long serialVersionUID = -697613910;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.EVENT_EXPERIMENTRUN, Indexes.EVENT_PRIMARY);
    }
    ...
    public Experimentrun experimentrun() {
        return new Experimentrun(this, Keys.EVENT_IBFK_1);
    }
