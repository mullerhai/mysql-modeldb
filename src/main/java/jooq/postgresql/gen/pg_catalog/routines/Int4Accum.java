...
public class Int4Accum extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1395135378;
     ...
     */
    public Int4Accum() {
        super("int4_accum", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
