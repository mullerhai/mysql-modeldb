...
public class JsonbInsert extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 1845443248;
     ...
     */
    public JsonbInsert() {
        super("jsonb_insert", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"jsonb\""));
