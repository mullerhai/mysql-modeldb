...
public class PgStatGetLastVacuumTime extends AbstractRoutine<OffsetDateTime> {
    ...
    private static final long serialVersionUID = 1994852480;
    ...
    public PgStatGetLastVacuumTime() {
        super("pg_stat_get_last_vacuum_time", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMPWITHTIMEZONE);
