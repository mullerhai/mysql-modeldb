...
public class Amvalidate extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -664594605;

    /**
     * The parameter <code>pg_catalog.amvalidate.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.amvalidate._1</code>.
     */
     ...
     */
    public Amvalidate() {
        super("amvalidate", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
