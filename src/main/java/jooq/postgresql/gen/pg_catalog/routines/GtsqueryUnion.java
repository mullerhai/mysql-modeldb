...
public class GtsqueryUnion extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 741858441;
    ...
    public GtsqueryUnion() {
        super("gtsquery_union", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
