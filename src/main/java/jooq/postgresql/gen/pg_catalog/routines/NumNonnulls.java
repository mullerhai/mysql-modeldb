...
public class NumNonnulls extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -2038430650;
     ...
     */
    public NumNonnulls() {
        super("num_nonnulls", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
