...
public class TimetzPlInterval extends AbstractRoutine<OffsetTime> {

    private static final long serialVersionUID = 1953422159;
    ...
    public TimetzPlInterval() {
        super("timetz_pl_interval", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMEWITHTIMEZONE);
