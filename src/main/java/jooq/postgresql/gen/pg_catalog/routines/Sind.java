...
public class Sind extends AbstractRoutine<Double> {
    ...
    private static final long serialVersionUID = -1808421244;

    /**
     * The parameter <code>pg_catalog.sind.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.sind._1</code>.
     */
     ...
     */
    public Sind() {
        super("sind", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
