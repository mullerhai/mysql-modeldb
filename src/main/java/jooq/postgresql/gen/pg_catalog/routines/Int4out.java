...
public class Int4out extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 1465238619;
     ...
     */
    public Int4out() {
        super("int4out", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"cstring\""));
