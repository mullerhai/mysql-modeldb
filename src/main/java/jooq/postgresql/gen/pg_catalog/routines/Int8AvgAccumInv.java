...
public class Int8AvgAccumInv extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -804081109;
    ...
    public Int8AvgAccumInv() {
        super("int8_avg_accum_inv", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
