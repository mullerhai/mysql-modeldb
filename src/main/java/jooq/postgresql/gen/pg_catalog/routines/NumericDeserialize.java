...
public class NumericDeserialize extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1797176922;
    ...
    /**
     * The parameter <code>pg_catalog.numeric_deserialize._1</code>.
     */
     ...
     */
    public NumericDeserialize() {
        super("numeric_deserialize", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
