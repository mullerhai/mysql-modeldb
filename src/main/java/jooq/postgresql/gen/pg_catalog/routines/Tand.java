...
public class Tand extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -517258839;

    /**
     * The parameter <code>pg_catalog.tand.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.tand._1</code>.
     */
     ...
     */
    public Tand() {
        super("tand", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
