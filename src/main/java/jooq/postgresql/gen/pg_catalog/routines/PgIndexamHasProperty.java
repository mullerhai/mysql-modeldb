...
public class PgIndexamHasProperty extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1639693524;

    /**
     * The parameter <code>pg_catalog.pg_indexam_has_property.RETURN_VALUE</code>.
     */
     ...
     */
    public PgIndexamHasProperty() {
        super("pg_indexam_has_property", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
