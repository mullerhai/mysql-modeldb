...
public class TimestamptzIn extends AbstractRoutine<OffsetDateTime> {

    private static final long serialVersionUID = -225217776;
    ...
    public TimestamptzIn() {
        super("timestamptz_in", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMPWITHTIMEZONE);
