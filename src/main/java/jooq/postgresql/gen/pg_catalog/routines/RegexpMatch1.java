...
public class RegexpMatch1 extends AbstractRoutine<String[]> {

    private static final long serialVersionUID = 1274565273;

    /**
     * The parameter <code>pg_catalog.regexp_match.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.regexp_match._1</code>.
     */
    public static final Parameter<String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CLOB, false, true);

    /**
     * The parameter <code>pg_catalog.regexp_match._2</code>.
     */
     ...
     */
    public RegexpMatch1() {
        super("regexp_match", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB.getArrayDataType());
