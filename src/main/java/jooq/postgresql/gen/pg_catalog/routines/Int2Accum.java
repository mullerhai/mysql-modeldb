...
public class Int2Accum extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -138754256;
     ...
     */
    public Int2Accum() {
        super("int2_accum", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
