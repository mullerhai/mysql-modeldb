...
public class Atand extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1361789594;

    /**
     * The parameter <code>pg_catalog.atand.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.atand._1</code>.
     */
     ...
     */
    public Atand() {
        super("atand", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
