...
public class Int8AvgSerialize extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = -1670363089;

    /**
     * The parameter <code>pg_catalog.int8_avg_serialize.RETURN_VALUE</code>.
     */
     ...
     */
    public Int8AvgSerialize() {
        super("int8_avg_serialize", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
