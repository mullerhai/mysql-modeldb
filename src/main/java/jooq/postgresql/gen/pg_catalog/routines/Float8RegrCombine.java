...
public class Float8RegrCombine extends AbstractRoutine<Double[]> {

    private static final long serialVersionUID = -422597052;

    /**
     * The parameter <code>pg_catalog.float8_regr_combine.RETURN_VALUE</code>.
     */
     ...
     */
    public Float8RegrCombine() {
        super("float8_regr_combine", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.FLOAT.getArrayDataType());
