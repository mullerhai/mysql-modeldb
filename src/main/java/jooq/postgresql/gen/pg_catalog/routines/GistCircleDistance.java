...
public class GistCircleDistance extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -404575014;

    /**
     * The parameter <code>pg_catalog.gist_circle_distance.RETURN_VALUE</code>.
     */
     ...
     */
    public GistCircleDistance() {
        super("gist_circle_distance", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
