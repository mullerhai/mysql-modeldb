...
public class PgIsolationTestSessionIsBlocked extends AbstractRoutine<Boolean> {
    ...
    private static final long serialVersionUID = 572591938;

    /**
     * The parameter <code>pg_catalog.pg_isolation_test_session_is_blocked.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.pg_isolation_test_session_is_blocked._1</code>.
     */
    public static final Parameter<Integer> _1 = createParameter("_1", org.jooq.impl.SQLDataType.INTEGER, false, true);

    /**
     * The parameter <code>pg_catalog.pg_isolation_test_session_is_blocked._2</code>.
     */
    ...
    public PgIsolationTestSessionIsBlocked() {
        super("pg_isolation_test_session_is_blocked", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
