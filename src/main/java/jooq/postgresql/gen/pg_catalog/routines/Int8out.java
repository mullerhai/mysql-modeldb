...
public class Int8out extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 937228418;
     ...
     */
    public Int8out() {
        super("int8out", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"cstring\""));
