...
public class PgStatGetBackendWaitEventType extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = -215353342;

    /**
     * The parameter <code>pg_catalog.pg_stat_get_backend_wait_event_type.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.pg_stat_get_backend_wait_event_type._1</code>.
     */
    ...
    public PgStatGetBackendWaitEventType() {
        super("pg_stat_get_backend_wait_event_type", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
