...
public class Atan2d extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1112213024;

    /**
     * The parameter <code>pg_catalog.atan2d.RETURN_VALUE</code>.
     */
     ...
     */
    public Atan2d() {
        super("atan2d", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
