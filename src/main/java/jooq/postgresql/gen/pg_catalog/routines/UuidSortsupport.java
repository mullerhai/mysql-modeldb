...
public class UuidSortsupport extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 925076631;
     ...
     */
    public UuidSortsupport() {
        super("uuid_sortsupport", PgCatalog.PG_CATALOG);
