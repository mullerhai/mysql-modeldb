...
public class NumericPolySerialize extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = -1962070033;

    /**
     * The parameter <code>pg_catalog.numeric_poly_serialize.RETURN_VALUE</code>.
     */
     ...
     */
    public NumericPolySerialize() {
        super("numeric_poly_serialize", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
