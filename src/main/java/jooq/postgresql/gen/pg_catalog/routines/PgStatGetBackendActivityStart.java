...
public class PgStatGetBackendActivityStart extends AbstractRoutine<OffsetDateTime> {
    ...
    private static final long serialVersionUID = 1092520710;
    ...
    public PgStatGetBackendActivityStart() {
        super("pg_stat_get_backend_activity_start", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMPWITHTIMEZONE);
