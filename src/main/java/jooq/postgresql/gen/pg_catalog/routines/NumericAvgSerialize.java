...
public class NumericAvgSerialize extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = -619526859;

    /**
     * The parameter <code>pg_catalog.numeric_avg_serialize.RETURN_VALUE</code>.
     */
     ...
     */
    public NumericAvgSerialize() {
        super("numeric_avg_serialize", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
