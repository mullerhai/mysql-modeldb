...
public class SpgBoxQuadChoose extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 817356748;
     ...
     */
    public SpgBoxQuadChoose() {
        super("spg_box_quad_choose", PgCatalog.PG_CATALOG);
