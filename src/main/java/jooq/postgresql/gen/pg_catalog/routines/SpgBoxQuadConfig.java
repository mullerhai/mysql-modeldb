...
public class SpgBoxQuadConfig extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 434422625;
     ...
     */
    public SpgBoxQuadConfig() {
        super("spg_box_quad_config", PgCatalog.PG_CATALOG);
