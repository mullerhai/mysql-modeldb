...
public class Float8Combine extends AbstractRoutine<Double[]> {

    private static final long serialVersionUID = 1172185650;

    /**
     * The parameter <code>pg_catalog.float8_combine.RETURN_VALUE</code>.
     */
     ...
     */
    public Float8Combine() {
        super("float8_combine", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.FLOAT.getArrayDataType());
