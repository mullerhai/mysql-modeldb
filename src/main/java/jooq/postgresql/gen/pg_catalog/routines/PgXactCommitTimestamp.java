...
public class PgXactCommitTimestamp extends AbstractRoutine<OffsetDateTime> {
    ...
    private static final long serialVersionUID = 1661074839;
    ...
    public PgXactCommitTimestamp() {
        super("pg_xact_commit_timestamp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMPWITHTIMEZONE);
