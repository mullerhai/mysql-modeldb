...
public class Xidneq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1211058490;
     ...
     */
    public Xidneq() {
        super("xidneq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
