...
public class Xidneqint4 extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1801988657;

    /**
     * The parameter <code>pg_catalog.xidneqint4.RETURN_VALUE</code>.
     */
     ...
     */
    public Xidneqint4() {
        super("xidneqint4", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
