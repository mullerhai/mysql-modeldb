...
public class Acosd extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1201131316;

    /**
     * The parameter <code>pg_catalog.acosd.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.acosd._1</code>.
     */
     ...
     */
    public Acosd() {
        super("acosd", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
