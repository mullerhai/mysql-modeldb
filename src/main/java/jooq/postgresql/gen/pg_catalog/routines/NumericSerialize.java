...
public class NumericSerialize extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 747319973;

    /**
     * The parameter <code>pg_catalog.numeric_serialize.RETURN_VALUE</code>.
     */
     ...
     */
    public NumericSerialize() {
        super("numeric_serialize", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
