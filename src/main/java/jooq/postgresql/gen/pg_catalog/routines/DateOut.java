...
public class DateOut extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1851041137;
     ...
     */
    public DateOut() {
        super("date_out", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"cstring\""));
