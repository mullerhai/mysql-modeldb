...
public class InetSpgChoose extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 555347781;
     ...
     */
    public InetSpgChoose() {
        super("inet_spg_choose", PgCatalog.PG_CATALOG);
