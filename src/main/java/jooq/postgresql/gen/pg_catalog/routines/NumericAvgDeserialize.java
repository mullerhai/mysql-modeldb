...
public class NumericAvgDeserialize extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 495068204;
     ...
     */
    public NumericAvgDeserialize() {
        super("numeric_avg_deserialize", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
