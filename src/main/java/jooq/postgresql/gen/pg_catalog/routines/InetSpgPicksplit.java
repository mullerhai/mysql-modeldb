...
public class InetSpgPicksplit extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1584957835;
     ...
     */
    public InetSpgPicksplit() {
        super("inet_spg_picksplit", PgCatalog.PG_CATALOG);
