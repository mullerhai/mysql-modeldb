...
public class TableToXmlAndXmlschema extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1795555500;
     ...
     */
    @java.lang.Deprecated
    public static final Parameter<Object> TBL = createParameter("tbl", org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"regclass\""), false, false);
    ...
    public TableToXmlAndXmlschema() {
        super("table_to_xml_and_xmlschema", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"xml\""));
