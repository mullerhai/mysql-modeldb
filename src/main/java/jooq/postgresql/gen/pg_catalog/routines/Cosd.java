...
public class Cosd extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 300222711;

    /**
     * The parameter <code>pg_catalog.cosd.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.cosd._1</code>.
     */
     ...
     */
    public Cosd() {
        super("cosd", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
