...
public class Int4AvgCombine extends AbstractRoutine<Long[]> {
    ...
    private static final long serialVersionUID = 1473169264;

    /**
     * The parameter <code>pg_catalog.int4_avg_combine.RETURN_VALUE</code>.
     */
    ...
    public Int4AvgCombine() {
        super("int4_avg_combine", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT.getArrayDataType());
