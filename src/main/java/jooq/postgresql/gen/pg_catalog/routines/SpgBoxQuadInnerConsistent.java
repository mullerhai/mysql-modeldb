...
public class SpgBoxQuadInnerConsistent extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -221441832;
     ...
     */
    public SpgBoxQuadInnerConsistent() {
        super("spg_box_quad_inner_consistent", PgCatalog.PG_CATALOG);
