...
public class NumericPolyDeserialize extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -177597472;
     ...
     */
    public NumericPolyDeserialize() {
        super("numeric_poly_deserialize", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
