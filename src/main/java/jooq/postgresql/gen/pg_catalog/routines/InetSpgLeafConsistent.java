...
public class InetSpgLeafConsistent extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -225236275;

    /**
     * The parameter <code>pg_catalog.inet_spg_leaf_consistent.RETURN_VALUE</code>.
     */
     ...
     */
    public InetSpgLeafConsistent() {
        super("inet_spg_leaf_consistent", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
