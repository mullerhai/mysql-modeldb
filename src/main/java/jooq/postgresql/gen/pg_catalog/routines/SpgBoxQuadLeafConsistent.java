...
public class SpgBoxQuadLeafConsistent extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 311841787;

    /**
     * The parameter <code>pg_catalog.spg_box_quad_leaf_consistent.RETURN_VALUE</code>.
     */
     ...
     */
    public SpgBoxQuadLeafConsistent() {
        super("spg_box_quad_leaf_consistent", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
