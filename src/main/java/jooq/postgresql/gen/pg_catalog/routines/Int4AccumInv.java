...
public class Int4AccumInv extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1487644500;
     ...
     */
    public Int4AccumInv() {
        super("int4_accum_inv", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
