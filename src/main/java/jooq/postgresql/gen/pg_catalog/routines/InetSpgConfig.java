...
public class InetSpgConfig extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 639092624;
     ...
     */
    public InetSpgConfig() {
        super("inet_spg_config", PgCatalog.PG_CATALOG);
