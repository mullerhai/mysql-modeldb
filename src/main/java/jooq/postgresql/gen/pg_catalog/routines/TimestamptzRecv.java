...
public class TimestamptzRecv extends AbstractRoutine<OffsetDateTime> {

    private static final long serialVersionUID = 329016899;
    ...
    public TimestamptzRecv() {
        super("timestamptz_recv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMPWITHTIMEZONE);
