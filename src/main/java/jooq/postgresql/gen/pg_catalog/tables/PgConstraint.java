...
import jooq.postgresql.gen.pg_catalog.tables.records.PgConstraintRecord;
...
public class PgConstraint extends TableImpl<PgConstraintRecord> {
    ...
    private static final long serialVersionUID = -917599691;
    ...
    public final TableField<PgConstraintRecord, Object> CONBIN = createField("conbin", org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"pg_node_tree\""), this, "");
