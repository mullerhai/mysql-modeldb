...
public class PgStatioSysSequences implements Serializable {

    private static final long serialVersionUID = 48663114;
    ...
    public PgStatioSysSequences(PgStatioSysSequences value) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("PgStatioSysSequences (");
