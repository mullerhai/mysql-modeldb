...
public class PgStatioAllTables implements Serializable {

    private static final long serialVersionUID = -1992866223;
    ...
    public PgStatioAllTables(PgStatioAllTables value) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("PgStatioAllTables (");
