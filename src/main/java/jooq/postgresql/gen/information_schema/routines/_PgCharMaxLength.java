...
public class _PgCharMaxLength extends AbstractRoutine<Integer> {
    ...
    private static final long serialVersionUID = -1033481175;

    /**
     * The parameter <code>information_schema._pg_char_max_length.RETURN_VALUE</code>.
     */
    ...
    public _PgCharMaxLength() {
        super("_pg_char_max_length", InformationSchema.INFORMATION_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
