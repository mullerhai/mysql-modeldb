...
public class _PgNumericPrecisionRadix extends AbstractRoutine<Integer> {
    ...
    private static final long serialVersionUID = 151721307;

    /**
     * The parameter <code>information_schema._pg_numeric_precision_radix.RETURN_VALUE</code>.
     */
    public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>information_schema._pg_numeric_precision_radix.typid</code>.
     */
    public static final Parameter<Long> TYPID = createParameter("typid", org.jooq.impl.SQLDataType.BIGINT, false, false);

    /**
     * The parameter <code>information_schema._pg_numeric_precision_radix.typmod</code>.
     */
    ...
    public _PgNumericPrecisionRadix() {
        super("_pg_numeric_precision_radix", InformationSchema.INFORMATION_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
