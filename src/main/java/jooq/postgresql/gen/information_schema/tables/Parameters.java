...
import jooq.postgresql.gen.information_schema.tables.records.ParametersRecord;
...
public class Parameters extends TableImpl<ParametersRecord> {
    ...
    private static final long serialVersionUID = -343558711;
     ...
     */
    public final TableField<ParametersRecord, String> IS_RESULT = createField("is_result", org.jooq.impl.SQLDataType.VARCHAR(3), this, "");

    /**
     * The column <code>information_schema.parameters.as_locator</code>.
     */
    public final TableField<ParametersRecord, String> AS_LOCATOR = createField("as_locator", org.jooq.impl.SQLDataType.VARCHAR(3), this, "");
