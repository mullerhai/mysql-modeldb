...
public class Dataframemetadata extends TableImpl<DataframemetadataRecord> {
    ...
    private static final long serialVersionUID = 1548972077;

    /**
     * The reference instance of <code>public.dataframemetadata</code>
     */
    ...
    /**
     * The column <code>public.dataframemetadata.id</code>.
     */
    public final TableField<DataframemetadataRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('dataframemetadata_seq'::regclass)", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>public.dataframemetadata.dfid</code>.
     */
    ...
    /**
     * The column <code>public.dataframemetadata.metadatakvid</code>.
     */
    ...
    /**
     * Create a <code>public.dataframemetadata</code> table reference
     */
    ...
    /**
     * Create an aliased <code>public.dataframemetadata</code> table reference
     */
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.DATAFRAMEMETADATA_PKEY);
    }
    ...
    public UniqueKey<DataframemetadataRecord> getPrimaryKey() {
        return Keys.DATAFRAMEMETADATA_PKEY;
    }
    ...
    public List<UniqueKey<DataframemetadataRecord>> getKeys() {
        return Arrays.<UniqueKey<DataframemetadataRecord>>asList(Keys.DATAFRAMEMETADATA_PKEY);
    }
    ...
    public List<ForeignKey<DataframemetadataRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<DataframemetadataRecord, ?>>asList(Keys.DATAFRAMEMETADATA__DATAFRAMEMETADATA_DFID_FKEY, Keys.DATAFRAMEMETADATA__DATAFRAMEMETADATA_METADATAKVID_FKEY);
    }

    public Dataframe dataframe() {
        return new Dataframe(this, Keys.DATAFRAMEMETADATA__DATAFRAMEMETADATA_DFID_FKEY);
    }

    public Metadatakv metadatakv() {
        return new Metadatakv(this, Keys.DATAFRAMEMETADATA__DATAFRAMEMETADATA_METADATAKVID_FKEY);
    }
