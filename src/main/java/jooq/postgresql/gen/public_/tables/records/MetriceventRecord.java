...
public class MetriceventRecord extends UpdatableRecordImpl<MetriceventRecord> implements Record6<Integer, Integer, Integer, String, Float, Integer> {

    private static final long serialVersionUID = 327108891;

    /**
     * Setter for <code>public.metricevent.id</code>.
     */
    ...
    /**
     * Getter for <code>public.metricevent.id</code>.
     */
    ...
    /**
     * Setter for <code>public.metricevent.transformer</code>.
     */
    ...
    /**
     * Getter for <code>public.metricevent.transformer</code>.
     */
    ...
    /**
     * Setter for <code>public.metricevent.df</code>.
     */
    ...
    /**
     * Getter for <code>public.metricevent.df</code>.
     */
    ...
    /**
     * Setter for <code>public.metricevent.metrictype</code>.
     */
    ...
    /**
     * Getter for <code>public.metricevent.metrictype</code>.
     */
    ...
    /**
     * Setter for <code>public.metricevent.metricvalue</code>.
     */
    ...
    /**
     * Getter for <code>public.metricevent.metricvalue</code>.
     */
    ...
    /**
     * Setter for <code>public.metricevent.experimentrun</code>.
     */
    ...
    /**
     * Getter for <code>public.metricevent.experimentrun</code>.
     */
     ...
     */
    @Override
    public MetriceventRecord value5(Float value) {
     ...
     */
    @Override
    public MetriceventRecord values(Integer value1, Integer value2, Integer value3, String value4, Float value5, Integer value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MetriceventRecord(Integer id, Integer transformer, Integer df, String metrictype, Float metricvalue, Integer experimentrun) {
        super(Metricevent.METRICEVENT);
