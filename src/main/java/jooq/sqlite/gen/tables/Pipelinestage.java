...
public class Pipelinestage extends TableImpl<PipelinestageRecord> {
    ...
    private static final long serialVersionUID = 1203392019;
     ...
     */
    public final TableField<PipelinestageRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.PIPELINESTAGE_EXPERIMENTRUN, Indexes.PIPELINESTAGE_PIPELINEFITEVENT, Indexes.PIPELINESTAGE_PRIMARY, Indexes.PIPELINESTAGE_TRANSFORMORFITEVENT);
    }
    ...
    public Fitevent fitevent() {
        return new Fitevent(this, Keys.PIPELINESTAGE_IBFK_1);
    }

    public Event event() {
        return new Event(this, Keys.PIPELINESTAGE_IBFK_2);
    }

    public Experimentrun experimentrun() {
        return new Experimentrun(this, Keys.PIPELINESTAGE_IBFK_3);
    }
