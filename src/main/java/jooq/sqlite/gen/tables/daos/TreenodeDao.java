...
public class TreenodeDao extends DAOImpl<TreenodeRecord, jooq.sqlite.gen.tables.pojos.Treenode, Integer> {

    /**
     * Create a new TreenodeDao without any configuration
     */
    public TreenodeDao() {
        super(Treenode.TREENODE, jooq.sqlite.gen.tables.pojos.Treenode.class);
    }
    ...
    public TreenodeDao(Configuration configuration) {
        super(Treenode.TREENODE, jooq.sqlite.gen.tables.pojos.Treenode.class, configuration);
    }
     ...
     */
    @Override
    protected Integer getId(jooq.sqlite.gen.tables.pojos.Treenode object) {
        return object.getId();
    }
     ...
     */
    public List<jooq.sqlite.gen.tables.pojos.Treenode> fetchById(Integer... values) {
     ...
     */
    public jooq.sqlite.gen.tables.pojos.Treenode fetchOneById(Integer value) {
     ...
     */
    public List<jooq.sqlite.gen.tables.pojos.Treenode> fetchByIsleaf(Integer... values) {
     ...
     */
    public List<jooq.sqlite.gen.tables.pojos.Treenode> fetchByPrediction(Double... values) {
     ...
     */
    public List<jooq.sqlite.gen.tables.pojos.Treenode> fetchByImpurity(Double... values) {
     ...
     */
    public List<jooq.sqlite.gen.tables.pojos.Treenode> fetchByGain(Double... values) {
     ...
     */
    public List<jooq.sqlite.gen.tables.pojos.Treenode> fetchBySplitindex(Integer... values) {
     ...
     */
    public List<jooq.sqlite.gen.tables.pojos.Treenode> fetchByRootnode(Integer... values) {
