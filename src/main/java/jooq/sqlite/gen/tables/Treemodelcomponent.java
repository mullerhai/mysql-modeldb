...
public class Treemodelcomponent extends TableImpl<TreemodelcomponentRecord> {
    ...
    private static final long serialVersionUID = 1287990238;
     ...
     */
    public final TableField<TreemodelcomponentRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.TREEMODELCOMPONENT_MODEL, Indexes.TREEMODELCOMPONENT_PRIMARY, Indexes.TREEMODELCOMPONENT_ROOTNODE);
    }
    ...
    public Transformer transformer() {
        return new Transformer(this, Keys.TREEMODELCOMPONENT_IBFK_1);
    }

    public Treenode treenode() {
        return new Treenode(this, Keys.TREEMODELCOMPONENT_IBFK_2);
    }
