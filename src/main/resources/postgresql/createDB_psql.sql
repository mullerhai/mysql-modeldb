...
CREATE TABLE Project (
  id int PRIMARY KEY DEFAULT NEXTVAL ('Project_seq'),
...
CREATE TABLE Experiment (
  id int PRIMARY KEY DEFAULT NEXTVAL ('Experiment_seq'),
...
ALTER SEQUENCE Experiment_seq RESTART WITH 1;
...
CREATE SEQUENCE ExperimentRun_seq;

CREATE TABLE ExperimentRun (
  id int PRIMARY KEY DEFAULT NEXTVAL ('ExperimentRun_seq'),
...
ALTER SEQUENCE ExperimentRun_seq RESTART WITH 1;

-- Metadata information
DROP TABLE IF EXISTS MetadataKV;
CREATE SEQUENCE MetadataKV_seq;

CREATE TABLE MetadataKV (
  id int PRIMARY KEY DEFAULT NEXTVAL ('MetadataKV_seq'),
...
ALTER SEQUENCE MetadataKV_seq RESTART WITH 1;
...
CREATE SEQUENCE DataFrame_seq;

CREATE TABLE DataFrame (
  id int PRIMARY KEY DEFAULT NEXTVAL ('DataFrame_seq'),
...
CREATE SEQUENCE DataFrameColumn_seq;

CREATE TABLE DataFrameColumn (
  id int PRIMARY KEY DEFAULT NEXTVAL ('DataFrameColumn_seq'),
  -- The ID of the DataFrame that has this column
  dfId int NOT NULL,
  foreign key(dfId)  REFERENCES DataFrame (id)  ,
...
ALTER SEQUENCE DataFrameColumn_seq RESTART WITH 1;
...
CREATE SEQUENCE DataFrameMetadata_seq;

CREATE TABLE DataFrameMetadata (
  id int PRIMARY KEY DEFAULT NEXTVAL ('DataFrameMetadata_seq'),
  -- id of the dataframe
  dfId int NOT NULL,
  foreign key(dfId)  REFERENCES DataFrame (id)  ,
-- id of the metadatakv
metadataKvId int NOT NULL,
foreign key(metadataKvId ) REFERENCES MetadataKV (id)  
) ;

ALTER SEQUENCE DataFrameMetadata_seq RESTART WITH 1;
...
CREATE SEQUENCE RandomSplitEvent_seq;

CREATE TABLE RandomSplitEvent (
  id int PRIMARY KEY DEFAULT NEXTVAL ('RandomSplitEvent_seq'),
  -- The DataFrame to split
  inputDataFrameId int NOT NULL,
  foreign key(inputDataFrameId)  REFERENCES DataFrame(id)  ,
...
ALTER SEQUENCE RandomSplitEvent_seq RESTART WITH 1;
...
CREATE SEQUENCE TransformerSpec_seq;

CREATE TABLE TransformerSpec (
  id int PRIMARY KEY DEFAULT NEXTVAL ('TransformerSpec_seq'),
...
ALTER SEQUENCE TransformerSpec_seq RESTART WITH 1;
...
CREATE SEQUENCE HyperParameter_seq;

CREATE TABLE HyperParameter (
  id int PRIMARY KEY DEFAULT NEXTVAL ('HyperParameter_seq'),
...
paramMinValue DOUBLE PRECISION,
-- The maximum value allowed for this hyperparameter
paramMaxValue  Double PRECISION,
-- The ExperimentRun that contains this hyperparameter
experimentRun int  NOT NULL,
foreign key(experimentRun )  REFERENCES ExperimentRun(id)  
) ;

ALTER SEQUENCE HyperParameter_seq RESTART WITH 1;
...
CREATE TABLE Transformer (
  id int PRIMARY KEY DEFAULT NEXTVAL ('Transformer_seq'),
...
explainedVariance DOUBLE PRECISION,
-- The R^2 value (coefficient of determiniation).
r2 DOUBLE PRECISION
) ;

ALTER SEQUENCE LinearModel_seq RESTART WITH 1;
...
CREATE SEQUENCE LinearModelTerm_seq;

CREATE TABLE LinearModelTerm (
    id int PRIMARY KEY DEFAULT NEXTVAL ('LinearModelTerm_seq'),
    -- This is the linear model.
    model  int  ,
   foreign key( model)  REFERENCES Transformer(id),
...
ALTER SEQUENCE LinearModelTerm_seq RESTART WITH 1;

-- The value of the objective function during the training of a model.
DROP TABLE IF EXISTS ModelObjectiveHistory;
CREATE SEQUENCE ModelObjectiveHistory_seq;

CREATE TABLE ModelObjectiveHistory (
    id int PRIMARY KEY DEFAULT NEXTVAL ('ModelObjectiveHistory_seq'),
    -- This is the linear model.
    model  int  ,
   foreign key( model )  REFERENCES Transformer(id),
...
ALTER SEQUENCE ModelObjectiveHistory_seq RESTART WITH 1;
...
CREATE SEQUENCE FitEvent_seq;

CREATE TABLE FitEvent (
  id int PRIMARY KEY DEFAULT NEXTVAL ('FitEvent_seq'),
  -- The TransformerSpec guiding the fitting
  transformerSpec  int  NOT NULL,
 foreign key( transformerSpec)  REFERENCES TransformerSpec(id)  ,
...
df  int  NOT NULL,
foreign key(df)  REFERENCES DataFrame (id)  ,
...
ALTER SEQUENCE FitEvent_seq RESTART WITH 1;
...
CREATE TABLE Feature (
  id int PRIMARY KEY DEFAULT NEXTVAL ('Feature_seq'),
...
ALTER SEQUENCE Feature_seq RESTART WITH 1;
...
CREATE SEQUENCE TransformEvent_seq;

CREATE TABLE TransformEvent (
  id int PRIMARY KEY DEFAULT NEXTVAL ('TransformEvent_seq'),
  -- The original DataFrame that is input into the Transformer
  oldDf  int  NOT NULL,
  foreign key(oldDf ) REFERENCES DataFrame(id)  ,
-- The output DataFrame of the Transformer
newDf int  NOT NULL,
foreign key( newDf)  REFERENCES DataFrame(id)  ,
...
ALTER SEQUENCE TransformEvent_seq RESTART WITH 1;
...
CREATE TABLE TreeNode (
  id int PRIMARY KEY DEFAULT NEXTVAL ('TreeNode_seq'),
  isLeaf int NOT NULL, -- 1 if node is leaf, 0 if node is internal
  prediction DOUBLE PRECISION NOT NULL, -- Internal nodes obviously do not use their predictions
  impurity DOUBLE PRECISION NOT NULL, -- Impurity of node.
  gain DOUBLE PRECISION, -- Information gain at node. NULL for leaf nodes.
...
ALTER SEQUENCE TreeNode_seq RESTART WITH 1;

DROP TABLE IF EXISTS TreeLink;
CREATE SEQUENCE TreeLink_seq;

CREATE TABLE TreeLink (
  id int PRIMARY KEY DEFAULT NEXTVAL ('TreeLink_seq'),
  parent int  NOT NULL,
 foreign key( parent)  REFERENCES TreeNode(id)  ,
child int  NOT NULL,
foreign key( child ) REFERENCES TreeNode(id)  ,
isLeft int NOT NULL -- 1 if the child is a left child and 0 if the child is a right child.
) ;

ALTER SEQUENCE TreeLink_seq RESTART WITH 1;

DROP TABLE IF EXISTS TreeModel;
CREATE SEQUENCE TreeModel_seq;

CREATE TABLE TreeModel (
  id int PRIMARY KEY DEFAULT NEXTVAL ('TreeModel_seq'),
  model int  NOT NULL,
 foreign key( model ) REFERENCES Transformer(id)  ,
modelType text NOT NULL -- Should be "Decision Tree", "GBT", or "Random Forest"
) ;

ALTER SEQUENCE TreeModel_seq RESTART WITH 1;
...
CREATE SEQUENCE TreeModelComponent_seq;

CREATE TABLE TreeModelComponent (
  id int PRIMARY KEY DEFAULT NEXTVAL ('TreeModelComponent_seq'),
  model int  ,
  foreign key(model )  REFERENCES Transformer(id),
componentIndex int NOT NULL,
componentWeight DOUBLE PRECISION NOT NULL,
rootNode int  NOT NULL,
foreign key( rootNode)  REFERENCES TreeNode(id)
) ;

ALTER SEQUENCE TreeModelComponent_seq RESTART WITH 1;

-- An event that represents the evaluation of a model given a DataFrame
DROP TABLE IF EXISTS MetricEvent;
CREATE SEQUENCE MetricEvent_seq;

CREATE TABLE MetricEvent (
  id int PRIMARY KEY DEFAULT NEXTVAL ('MetricEvent_seq'),
...
ALTER SEQUENCE MetricEvent_seq RESTART WITH 1;
...
CREATE SEQUENCE PipelineStage_seq;

CREATE TABLE PipelineStage (
  id int PRIMARY KEY DEFAULT NEXTVAL ('PipelineStage_seq'),
  pipelineFitEvent int  NOT NULL,
  foreign key(pipelineFitEvent )  REFERENCES FitEvent(id)  ,
transformOrFitEvent int  NOT NULL,
foreign key(transformOrFitEvent)  REFERENCES Event(id)  ,
...
ALTER SEQUENCE PipelineStage_seq RESTART WITH 1;

DROP TABLE IF EXISTS CrossValidationEvent;
CREATE SEQUENCE CrossValidationEvent_seq;

CREATE TABLE CrossValidationEvent (
  id int PRIMARY KEY DEFAULT NEXTVAL ('CrossValidationEvent_seq'),
  df int  NOT NULL,
 foreign key( df)  REFERENCES DataFrame(id)  ,
spec int  NOT NULL,
foreign key(spec)  REFERENCES TransformerSpec(id)  ,
...
ALTER SEQUENCE CrossValidationEvent_seq RESTART WITH 1;

DROP TABLE IF EXISTS CrossValidationFold;
CREATE SEQUENCE CrossValidationFold_seq;

CREATE TABLE CrossValidationFold (
  id int PRIMARY KEY DEFAULT NEXTVAL ('CrossValidationFold_seq'),
  metric int  NOT NULL,
  event int  NOT NULL,
  experimentRun int  NOT NULL,
 foreign key( metric )  REFERENCES MetricEvent(id)  ,
foreign key(event )  REFERENCES CrossValidationEvent(id)  ,
foreign key( experimentRun )  REFERENCES ExperimentRun(id)  
) ;

ALTER SEQUENCE CrossValidationFold_seq RESTART WITH 1;

DROP TABLE IF EXISTS GridSearchCrossValidationEvent;
CREATE SEQUENCE GridSearchCrossValidationEvent_seq;

CREATE TABLE GridSearchCrossValidationEvent (
  id int PRIMARY KEY DEFAULT NEXTVAL ('GridSearchCrossValidationEvent_seq'),
  numFolds int NOT NULL,
  best int  NOT NULL,
  experimentRun int  NOT NULL,
  foreign key(best)  REFERENCES FitEvent(id)  ,
foreign key( experimentRun)  REFERENCES ExperimentRun(id)  
) ;

ALTER SEQUENCE GridSearchCrossValidationEvent_seq RESTART WITH 1;

DROP TABLE IF EXISTS GridCellCrossValidation;
CREATE SEQUENCE GridCellCrossValidation_seq;

CREATE TABLE GridCellCrossValidation (
  id int PRIMARY KEY DEFAULT NEXTVAL ('GridCellCrossValidation_seq'),
  gridSearch int  NOT NULL,
  crossValidation int  NOT NULL,
  experimentRun int  NOT NULL,
 foreign key( gridSearch)  REFERENCES GridSearchCrossValidationEvent(id)  ,
foreign key( crossValidation ) REFERENCES CrossValidationEvent(id)  ,
foreign key(experimentRun ) REFERENCES ExperimentRun(id)  
) ;

ALTER SEQUENCE GridCellCrossValidation_seq RESTART WITH 1;
...
CREATE TABLE Annotation (
  id int PRIMARY KEY DEFAULT NEXTVAL ('Annotation_seq'),
  posted timestamp(0) NOT NULL,
  experimentRun int  NOT NULL,
  foreign key(experimentRun)  REFERENCES ExperimentRun(id)  
) ;

ALTER SEQUENCE Annotation_seq RESTART WITH 1;
...
CREATE SEQUENCE AnnotationFragment_seq;

CREATE TABLE AnnotationFragment (
  id int PRIMARY KEY DEFAULT NEXTVAL ('AnnotationFragment_seq'),
...
ALTER SEQUENCE AnnotationFragment_seq RESTART WITH 1;
